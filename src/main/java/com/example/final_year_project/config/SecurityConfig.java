    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/notes/list", "/api/notes/search").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/recommend/list").permitAll()
                        .requestMatchers(req -> req.getMethod().equals("GET") && req.getRequestURI().matches("/api/notes/\\d+")).permitAll()
